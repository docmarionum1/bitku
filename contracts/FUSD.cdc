...
pub contract FUSD: FungibleToken {
    ...
    // Copied from https://github.com/onflow/kitty-items/blob/master/cadence/contracts/FUSD.cdc#L195
    // Not the actual FUSD contract, but this deploys to the emulator.
    init() {
